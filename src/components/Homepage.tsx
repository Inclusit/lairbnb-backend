    ...
    <div className="flex flex-col items-center justify-center p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
        <Card className="bg-white shadow-md rounded-lg overflow-hidden">
          <CardContent className="p-4">
            <h2 className="font-semibold text-xl mb-2">
              Lägg upp ditt boende på LairBnb
            </h2>
            <img
            ...
            />
            <p className="text-gray-600 mb-4">
              Dela din unika plats och nå fler gäster! Genom att lägga upp ditt
              boende på vår plattform får du exponering till en bredare publik
              av resenärer som söker efter unika och minnesvärda upplevelser.
              Tillsammans kan vi göra ditt boende till deras nästa
              favoritdestination!
            </p>
        ...
        <Card className="bg-white shadow-md rounded-lg overflow-hidden" style={{ height: 'auto', width: '100%' }}>
          <CardContent className="p-4">
            <h2 className="font-semibold text-xl mb-2">
              LairBnb hjälper dig hela vägen
            </h2>
            <img
            ...
            />
            <p className="text-gray-600 mb-4">
              Vår plattform är designad för att förenkla din uthyrningsprocess.
              Med lättanvända verktyg kan du enkelt hantera bokningar,
              kommunicera med gäster och få insikter om din verksamhet. Låt oss
              hjälpa dig att maximera din uthyrning och skapa fantastiska minnen
              för dina gäster!
            </p>
        ...
        <Card className="bg-white shadow-md rounded-lg overflow-hidden" style={{ height: 'auto', width: '100%' }}>
          <CardContent className="p-4">
            ...
            />
            <p className="text-gray-600 mb-4">
              Upptäck din nästa äventyrsplats med oss! Oavsett om du är på jakt
              efter en avkopplande helg eller ett spännande äventyr, har vi ett
              brett utbud av boenden som passar alla smaker och budgetar. Låt
              oss hjälpa dig att skapa oförglömliga minnen med dina nära och
              kära!
            </p>
