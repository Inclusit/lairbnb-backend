...
export default function Hero() {
    return (
        ...
        <div className="max-w-[1450px] w-full h-full flex items-center justify-center">
            ...
            <h1 className="text-black text-5xl font-bold mb-4 ">Find your next adventure</h1>
            <p className="text-black text-lg mb-8">Upptäck de bästa platserna att bo på. Vi erbjuder unika och bekväma
        boenden för alla smaker!</p>
